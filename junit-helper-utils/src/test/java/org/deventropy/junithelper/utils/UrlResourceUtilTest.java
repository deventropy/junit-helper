...
public class UrlResourceUtilTest {
	...
	/**
	 * Test method for {@link org.deventropy.junithelper.utils.UrlResourceUtil#getUrl(java.lang.String)}.
...
//		log.debug("Temp file url = {}", url);
	...
	public void testGetUrlClasspath () throws IOException {
		// CHECK 1
		String url = "classpath:/org/deventropy/junithelper/utils/classpath-url-test.file";
...
//		log.debug("Resolved: {}", resolved);
		...
		// CHECK 2
		url = "classpath:org/deventropy/junithelper/utils/classpath-url-test.file";
