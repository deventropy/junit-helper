 ...
 */
@NotThreadSafe
public class InMemoryDbCustomDirBadScriptTest extends AbstractEmbeddedDerbyResourceTest {
	
	private static final String DB_NAME = "my-test-database-simple01-customdir-badscript";
