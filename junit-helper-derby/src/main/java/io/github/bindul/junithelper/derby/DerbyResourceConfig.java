...
public class DerbyResourceConfig {
	 ...
	 */
	public DerbyResourceConfig setDatabaseName(String databaseName) {
	 ...
	 * @see <a href="http://db.apache.org/derby/docs/10.11/ref/rrefjdbc37352.html">Syntax of database connection URLs</a>
	 */
	...
	/**
	 * Sets the {@link #getErrorLoggingMode()} value to {@link ErrorLoggingMode#Null}; and clears other logging properties
	 * 
	 * @return This instance
	 */
	...
	/**
	 * Sets the {@link #getErrorLoggingMode()} value to {@link ErrorLoggingMode#Default}; and clears other logging properties
	 * 
	 * @return This instance
	 */
	 ...
	 * 
	 * A post init script should refer to a file containing SQL DDL or DML statements that will be executed against
	 * the new derby instance. Script locations can be on the classpath or file system or on a HTTP(s) location, for 
	 * format, see {@linkplain io.github.bindul.junithelper.utils.UrlResourceUtil}.
	 * 
